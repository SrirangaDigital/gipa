...
?>
			...
			<div class="newswithborder">
				...
				<p class="flash-news"><img class="playbooksicon" src="php/images/google-play-books.png" alt="Google Play Books Logo" title="Google Play Books"/> Link: <a class="bld_color" href="https://play.google.com/store/books/author?id=D+V+Gundappa" target="_blank">sriranga.digital/dvg</a></p>
			</div>	
